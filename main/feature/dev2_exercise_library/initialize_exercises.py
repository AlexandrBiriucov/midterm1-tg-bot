...
# -*- coding: utf-8 -*-
"""
Database Initialization Script for Exercise Library
Populates the SQLite database with 270+ exercises
"""
...
from dev2_exercise_library.exercise_db import ExerciseDatabase

def initialize_chest_exercises(db: ExerciseDatabase):
    """Add chest exercises"""
    print("📦 Adding chest exercises...")
    ...
    print(f"✅ Added {len(exercises)} chest exercises")


def initialize_back_exercises(db: ExerciseDatabase):
    """Add back exercises"""
    print("📦 Adding back exercises...")
    ...
    print(f"✅ Added {len(exercises)} back exercises")


def initialize_shoulder_exercises(db: ExerciseDatabase):
    """Add shoulder exercises"""
    print("📦 Adding shoulder exercises...")
    ...
    print(f"✅ Added {len(exercises)} shoulder exercises")


def initialize_arm_exercises(db: ExerciseDatabase):
    """Add arm exercises"""
    print("📦 Adding arm exercises...")
    ...
    print(f"✅ Added {len(exercises)} arm exercises")


def initialize_leg_exercises(db: ExerciseDatabase):
    """Add leg exercises"""
    print("📦 Adding leg exercises...")
    ...
    print(f"✅ Added {len(exercises)} leg exercises")


def initialize_ab_exercises(db: ExerciseDatabase):
    """Add ab exercises"""
    print("📦 Adding ab exercises...")
    ...
    print(f"✅ Added {len(exercises)} ab exercises")


def initialize_cardio_exercises(db: ExerciseDatabase):
    ...
    print(f"✅ Added {len(exercises)} cardio exercises")


def initialize_functional_exercises(db: ExerciseDatabase):
    """Add functional exercises"""
    print("📦 Adding functional exercises...")
    ...
    print(f"✅ Added {len(exercises)} functional exercises")


def initialize_stretching_exercises(db: ExerciseDatabase):
    """Add stretching exercises"""
    print("📦 Adding stretching exercises...")
    ...
    print(f"✅ Added {len(exercises)} stretching exercises")
...
def initialize_all():
    ...
    print(f"\n💾 Database file: {db.db_file}")
    print(f"🤖 Exercise library is ready to use!")
